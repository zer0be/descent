...
$query_rsLog = sprintf("SELECT DATE_FORMAT(quest_timestamp,'%%b %%d %%Y') AS date, quest_name,  quest_name_win, quest_encount_1, quest_id FROM tbquests WHERE quest_game_id = %s ORDER BY quest_timestamp DESC", GetSQLValueString($gameID, "int"));
      ...
      <table cellpadding="5" cellspacing="5" class="purpleTable">
        ...
        <?php do { ?>
          ...
          <tr>
            ...
            <td align="center">&nbsp;</td>
            <td colspan="2" align="center"><a href="dungeondetail.php?urlGamingID=<?php echo $row_rsGroupCampaign['ggrp_id']; ?>&amp;urlDungeonID=<?php echo $row_rsLog['quest_name']; ?>" class="normal">View Details About the Dungeon Here</a></td>
          </tr>
